...
# ✅ 메인 실행 함수
def main():
    st.set_page_config(page_title="POST-IPO 실적 분석 대시보드", layout="wide")
    ...
    selected_reports = st.sidebar.multiselect("📄 보고서 유형 선택", df["보고서명"].unique().tolist(), default=df["보고서명"].unique().tolist())
